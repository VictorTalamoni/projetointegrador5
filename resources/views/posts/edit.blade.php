                ...
                @endif
                    <form method="POST" action="{{ route('posts.update', $postDetails['_id']) }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="preco" type="text" inputmode="decimal" pattern="[0-9]+([,\.]?[0-9]{1,2})?" class="form-control @error('preco') is-invalid @enderror" name="preco" value="{{ $postDetails['preco'] }}" required autocomplete="preco">
